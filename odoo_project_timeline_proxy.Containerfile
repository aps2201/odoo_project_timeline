...
CMD  python3.12 /apps/odoo/odoo-bin -D /usr/share/odoo -d odoo --config /etc/odoo/conf/odoo.conf --init base,project,project_timeline,web_timeline --proxy-mode --without-demo all